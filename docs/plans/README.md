...
| 2′ — Single-user auth + CLI + tunnel | [2026-08-28-phase-2-single-user-auth-cli.md](2026-08-28-phase-2-single-user-auth-cli.md) | **in progress** (started 2026-08-28) | 16 tasks. Re-scoped per `../superpowers/specs/2026-08-28-single-user-local-tunnel-design.md`: owner secret, JSON state in `_brainstem/`, Cloudflare named/quick tunnel, TypeScript CLI. The multi-user Phase 2/3/4 outlines below are **deferred** (see spec §2). |
