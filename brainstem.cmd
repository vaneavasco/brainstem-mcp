...
cd /d "%~dp0"
where node >nul 2>nul || (echo Node.js 24 is required. Install: winget install OpenJS.NodeJS.LTS 1>&2 & exit /b 1)
...
where docker >nul 2>nul || (echo Docker Desktop is required: https://docs.docker.com/desktop/ 1>&2 & exit /b 1)
:after_docker_check
